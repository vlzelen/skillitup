(() => {
    ...
    s.n = e => {
        ...
        var e = s(89),
            ...
            r = s(522),
            i = s(634);
        const c = JSON.parse('["skillitup\\\\.org(?:/.*)?/ola/services/.*","skillitup\\\\.org/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://89ed2afe-e473-482e-8a07-3bd562650348\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]').map((e => new RegExp(e))),
            o = JSON.parse('["skillitup\\\\.org(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/89ed2afe-e473-482e-8a07-3bd562650348/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/89ed2afe-e473-482e-8a07-3bd562650348/feed"]').map((e => new RegExp(e))),
            h = JSON.parse('["/transform-frankfort","/cohort-learning","/home-original","/","/faqs"]').map((e => ({
                url: e,
                revision: "1742574144180"
            })));
        self.addEventListener("activate", (function(e) {
            e.waitUntil(caches.keys().then((function(e) {
                return Promise.all(e.filter((e => e.startsWith("skillitup.org-"))).map((e => caches.delete(e))))
            })))
